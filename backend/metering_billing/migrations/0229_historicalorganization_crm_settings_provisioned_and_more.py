    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(
                ...
                to="metering_billing.unifiedcrmcustomerintegration",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.DO_NOTHING,
                related_name="+",
                to="metering_billing.unifiedcrminvoiceintegration",
            ),
        ),
        migrations.AddField(
            model_name="invoice",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("organization", "crm_provider"), name="unique_crm_provider"
            ),
        ),
        migrations.AddConstraint(
            model_name="unifiedcrmcustomerintegration",
            constraint=models.UniqueConstraint(
                condition=models.Q(("native_customer_id__isnull", False)),
