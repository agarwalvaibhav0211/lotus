...
The python SDK uses an internal queue with automatic batching and flushing for the events tracking functionality, but uses blocking calls for the rest of the API. You can find the [SDK repository here](https://github.com/agarwalvaibhav0211/lotus-python).
